...
# Setup the root folder for the input and output
_FolderName=''
_ReviewDataset = os.path.join(_FolderName,'0.ReviewDataset.txt')
_PreProcessedData = os.path.join(_FolderName, '1.PreProcessedData.txt')
_TokenizedReviews = os.path.join(_FolderName, '2.TokenizedReviews.txt')
_PosTaggedReviews = os.path.join(_FolderName, '3.PosTaggedReviews.txt')
_Aspects = os.path.join(_FolderName, '4.Aspects.txt')
_Opinions = os.path.join(_FolderName, '5.Opinions.txt')
...
identifyOpinionWords(_PosTaggedReviews,_Aspects,_Opinions,printResultChoice())
